 ...
 * Mendukung eksekusi berjenjang 4-Tier, seleksi flag --tier, filtering, pelaporan terstruktur,
 * dan semantik exit code (0 untuk 100% lulus, 1 untuk kegagalan).
 *
...
// Engine Pelari Tes Mikro Mandiri (Eksekusi Sekuensial dengan Guard Timeout)
class TestContext {
  constructor(options) {
