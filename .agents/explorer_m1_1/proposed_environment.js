/**
 * Konfigurasi Variabel Lingkungan Sistem Minecraft Autonomous Companion
 * Membaca dan memvalidasi variabel lingkungan dari .env dengan nilai fallback default.
 */

const dotenv = require('dotenv');
const path = require('path');

// Muat berkas .env dari direktori root proyek jika ada
...
const environment = {
  ...
  // Konfigurasi Server Web Dashboard & Telemetry Hub (Port 8080)
  server: {
  ...
  // Konfigurasi Batch Ingestion Telemetri
  telemetry: {
    flushIntervalMs: parseInt(process.env.TELEMETRY_FLUSH_INTERVAL_MS || '250', 10),
    batchSizeLimit: parseInt(process.env.TELEMETRY_BATCH_SIZE_LIMIT || '100', 10)
  }
};
